...
import net.sf.jremoterun.utilities.nonjdk.console.inout.RedirectOutStream;
...
//    }
    ...
    public static File calcRunnerFile() throws IOException {
    ...
    public static void setAdder2() throws IOException {
    ...
    public static void f1() throws Exception {
        ...
        if (calcRunnerFile != null) {
            RunnableFactory.runRunnerC(calcRunnerFile,JrrClassUtils.getCurrentClass());
