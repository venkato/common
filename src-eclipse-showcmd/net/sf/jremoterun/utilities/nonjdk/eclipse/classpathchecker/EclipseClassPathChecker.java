...
public class EclipseClassPathChecker {
	...
	public static ClRef jna = new ClRef("com.sun.jna.Callback"); 
	public static ClRef egitActivator = new ClRef("org.eclipse.egit.core.Activator"); 
	public static ClRef jgitActivator = new ClRef("org.eclipse.jgit.api.CloneCommand"); 
	public static ClRef svnOpActivator = new ClRef("org.tigris.subversion.subclipse.ui.operations.UpdateOperation"); 
	
	
	public void checkImpl(EquinoxClassLoader currentClassLoader) {
		
		helper.checkTheSameClassLoader5(new ClRef("org.apache.log4j.Logger"), currentClassLoader);
