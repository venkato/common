...
public class SetEclipseLogHandler {
	...
	public static void setMyErrorHandler(WorkbenchAdvisor workbenchAdvisor,IDEWorkbenchErrorHandler errorHandler) throws Exception {
		JrrClassUtils.setFieldValueR( new ClRef("org.eclipse.ui.internal.ide.application.IDEWorkbenchAdvisor"), workbenchAdvisor, "ideWorkbenchErrorHandler", errorHandler);
	}
	...
	public static void setLogHandler() {
		try {
			...
			net.sf.jremoterun.utilities.JrrUtilitiesShowE.showException("eclipse 8 start 123", e);
			e.printStackTrace();
