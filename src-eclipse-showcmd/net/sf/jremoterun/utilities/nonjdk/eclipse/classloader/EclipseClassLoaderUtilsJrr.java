...
public class EclipseClassLoaderUtilsJrr {
	...
	public static Collection<String> getPlugins() throws Exception {
		...
		FrameworkWiring frameworkWiring = (FrameworkWiring) JrrClassUtils.getFieldValue(InternalPlatform.getDefault(),
				"fwkWiring");
		ModuleContainer moduleContainer = (ModuleContainer) JrrClassUtils.getFieldValue(frameworkWiring, "this$0");
