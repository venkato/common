...
public class UserLibraryConfigurator extends AddFileWithSources {
	...
	public ClasspathEntry createClasspathEntry(File bin1, List<File> src1) {
		return createClasspathEntryS(bin1, src1);
	}
	
	public static ClasspathEntry createClasspathEntryS(File bin1, List<File> src1) {
