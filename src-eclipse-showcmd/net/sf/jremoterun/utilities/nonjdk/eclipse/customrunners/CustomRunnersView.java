...
//		panel2.removeAll();
		...
		for (final File file : listFiles) {
			if (file.isFile() && file.getName().endsWith(ClassNameSuffixes.dotgroovy.getCustomName())) {
...
//				panel2.add(openFileButton);
	...
	static Button createActionButton(Composite parent, final File f) {
		...
		button.setText(f.getName().replace(ClassNameSuffixes.dotgroovy.getCustomName(), ""));
