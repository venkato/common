...
public class PushForceImpl2 implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		...
		try {
			...
			net.sf.jremoterun.utilities.JrrUtilitiesShowE.showException("Push force failed", e);
		}
	}
	...
	public static String findMyRemote(File file) {
		...
		GitRemoteFind gitRemoteFind = new GitRemoteFindEclipse(myUserName);
