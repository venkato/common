...
class SelectedRepositoryComputer {
	...
	private final List<File> configuredRepositoryLocations;
	...
	private File getRepositoryLocation(IResource resource) {
		...
		if (resourceLocation != null) {
			for (File repositoryLocation2 : configuredRepositoryLocations) {
				File repositoryLocation = repositoryLocation2;
