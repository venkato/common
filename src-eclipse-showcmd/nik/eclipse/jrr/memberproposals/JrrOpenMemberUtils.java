...
public class JrrOpenMemberUtils {
	...
	public static EnumSet<StaticFieldType> reFields =  net.sf.jremoterun.utilities.nonjdk.staticanalizer.StaticFieldTypeCollection.reFields; 
//			EnumSet.of(StaticFieldType.setFieldValue,
//			StaticFieldType.getFieldValue, StaticFieldType.findField);

	public static EnumSet<StaticFieldType> reMethods = EnumSet.of(StaticFieldType.invokeMethod,
			StaticFieldType.findMethod);
						...
						if (lastIJavaElement == null) {
							...
							if (codeResolve[0] instanceof IMethod) {
								...
								if (JrrClassUtils.class.getName().equals(fullyQualifiedName)) {
									cmpb.reflectionElement = StaticFieldType.valueOf(new_name.getElementName());
	...
	private void notUsed() throws Throwable {
		ClassMemberProposalBean cmpb = null;
		JrrClassUtils.getFieldValue(String.class, "CASE_INSENSITIVE_ORDER"); //NOFIELDCHECK
		JrrClassUtils.getFieldValue(String.class, "serialPersistentFis"); //NOFIELDCHECK
		JrrClassUtils.getFieldValue(String.class, "serialPersistentFields"); //NOFIELDCHECK
		JrrClassUtils.invokeMethod(cmpb.stringLiteral, "nodeClassForType", 1); //NOFIELDCHECK
		JrrClassUtils.invokeMethod(cmpb.stringLiteral.getClass(), "nodeClassForType", 1); //NOFIELDCHECK
		JrrClassUtils.invokeMethod(StringLiteral.class, "nodeClassForType", 1); //NOFIELDCHECK
		JrrClassUtils.findField(StringLiteral.class, "ANNOTATION_TYPE_DECLARATION"); //NOFIELDCHECK
		JrrClassUtils.getFieldValue(cmpb.stringLiteral, "PROPERTY_DESCRIPTORS"); //NOFIELDCHECK
		JrrClassUtils.getFieldValue(cmpb.stringLiteral, "parent"); //NOFIELDCHECK
		JrrClassUtils.invokeMethod(String.class, "length"); //NOFIELDCHECK
