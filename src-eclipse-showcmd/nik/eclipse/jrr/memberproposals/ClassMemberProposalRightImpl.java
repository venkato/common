...
public class ClassMemberProposalRightImpl implements IJavaCompletionProposalComputer {
	...
	public static List<ICompletionProposal> createProposals(ClassMemberProposalBean fpb) throws Exception {
		...
		if (false) {
			...
			JrrClassUtils.invokeMethod(fpb.stringLiteral.getClass(), "getParent"); // NOFIELDCHECK
			JrrClassUtils.invokeMethod(String.class, "e"); // NOFIELDCHECK
//			JrrClassUtils.invokeMethod("", "hashCode"); // NOFIELDCHECK
			JrrClassUtils.invokeMethod("", "equals", 1); // NOFIELDCHECK
			JrrClassUtils.invokeMethod(String.class, "hash"); // NOFIELDCHECK
			JrrClassUtils.invokeMethod(fpb.stringLiteral, "getLiteralValue"); // NOFIELDCHECK
			JrrClassUtils.getFieldValue(ClassMemberProposalRightImpl.class, "logger"); // NOFIELDCHECK
		}
