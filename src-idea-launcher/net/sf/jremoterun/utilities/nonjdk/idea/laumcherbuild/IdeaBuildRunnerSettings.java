...
//    @Deprecated
//    public static volatile File ideaBuilderConfigFile = new File(net.sf.jremoterun.utilities.nonjdk.idea.laumcherbuild.config.JrrStarterVariables2.getInstance().filesDir, ideaBuilderConfigFileName);
    //public static File jrrlibpathF = new File(userHome, "jrr/configs/jrrlibpath.txt");
    public static volatile File jrrlibpathF = new File(net.sf.jremoterun.utilities.nonjdk.idea.laumcherbuild.config.JrrStarterVariables2.getInstance().filesDir, "jrrlibpath.txt");
    //new File(userHome, "jrr/configs/"+ideaBuilderConfigFileName);


    @Deprecated
    public static volatile File userSettingsDir = net.sf.jremoterun.utilities.nonjdk.idea.laumcherbuild.config.JrrStarterVariables2.getInstance().classesDir;
