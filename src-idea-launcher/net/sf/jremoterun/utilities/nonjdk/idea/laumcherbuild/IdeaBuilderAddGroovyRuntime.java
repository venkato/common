...
//        jrrpath = jrrPathDefault.getAbsolutePath();
    ...
    public static void addUrlToCl(ClassLoader cl, File fileToAdd) throws Exception {
        ...
        if (cl instanceof URLClassLoader) {
            ...
            addUrlM.invoke(cl, fileToAdd.toURL());
        } else {
            if (addUrlMJava11 == null) {
                Class cll = cl.loadClass("jdk.internal.loader.BuiltinClassLoader");
                addUrlMJava11 = cll.getDeclaredMethod("appendClassPath", String.class);
                addUrlMJava11.setAccessible(true);
            }
            addUrlMJava11.invoke(cl, fileToAdd.getAbsolutePath());
        }
