...
class RstaRunnerWithStackTrace extends RstaRunner {
    ...
    public static List<String> ignoreClassesDefault = [
            'java.awt', 'javax.swing', 'groovy.lang.Closure.', RstaRunner.getPackage().getName(),
            'java.security.AccessController',
            net.sf.jremoterun.utilities.javassist.BaseMethodHandler.getName(),
            net.sf.jremoterun.utilities.javaservice.CallProxyGeneralHandler.getName(),
            //'java.lang.Thread',
    ];

    static {
        ignoreClassesDefault.addAll(JrrClassUtils.ignoreClassesForCurrentClass);
    }

    List<String> ignoreClasses = ignoreClassesDefault;
