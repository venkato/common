...
@CompileStatic
class GradleRepoUtils {
    private static final Logger log = JrrClassUtils.getJdkLogForCurrentClass();


    static void addDefaultRepo(URL url9){
        GradleEnvsUnsafe.gradle.addProjectEvaluationListener(new ProjectEvaluationListener() {

            boolean addedMyRepo = false
...
//    static org.gradle.plugin.management.internal.DefaultPluginManagementSpec pluginManagementGet(){
