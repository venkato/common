        ...
        extends MavenSnapshotMetadata
{
    ...
    public RemoteSnapshotMetadataJrr( Artifact artifact, boolean legacyFormat, Date timestamp, RepositorySystemSession session )
    {
        super( createRepositoryMetadata( artifact, legacyFormat ), null, legacyFormat, timestamp );
        this.session = session;
    }

    public RemoteSnapshotMetadataJrr( Metadata metadata, File file, boolean legacyFormat, Date timestamp, RepositorySystemSession session )
    {
    ...
    {
        return new RemoteSnapshotMetadataJrr( metadata, file, legacyFormat, timestamp, session );
    }
