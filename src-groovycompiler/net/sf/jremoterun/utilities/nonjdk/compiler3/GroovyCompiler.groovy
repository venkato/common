...
class GroovyCompiler {
    ...
    public HashSet<String> resolvedClasses = [];
    public HashSet<String> failedResolvedClasses = [];
...
//            GroovyExtensionMethodsReloader.rescanExtensionMethods(JrrClassUtils.getCurrentClassLoader());
  ...
  //          log.info "resolvedClasses : ${resolvedClasses.size()}"
//            log.info "failedResolvedClasses : ${failedResolvedClasses.size()} : ${failedResolvedClasses.sort().join('\n')}"
        }
    }
