...
//    List<String> additionalFlags = []
    ...
    public EclipseCompiler3 compiler3
...
//                addJavacError("Compile error during compilation with javac.", cu, javacOutput);
    ...
    boolean doCompile(PrintWriter writer, String[] javacParameters) {
        compiler3 = new EclipseCompiler3(writer, writer, false, null, null,rememberOutput,params.annotationProcessorManagerDummy,params.enableBootClassPath)
        compiler3.logger = new EclipseCompilerLoggerJrr(compiler3, writer, writer);
