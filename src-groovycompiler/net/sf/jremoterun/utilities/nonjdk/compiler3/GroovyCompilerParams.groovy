...
class GroovyCompilerParams implements Serializable {
    ...
    boolean checkFilesPresentInDir = true
     ...
     */
    List<ClRef> testNotFoundInParentClassLoaded = []
    ...
    Map<String, Boolean> groovyOptimizationOptions = [:]
    boolean annotationProcessorManagerDummy= false
    boolean generateGroovyMethods = true;
    int printFirstErrorsOnClassGeneration = 10;
    boolean groovyDebugFlag = true
    boolean reloadExtMethods = true
    Integer groovyMaxErrorTolerance
