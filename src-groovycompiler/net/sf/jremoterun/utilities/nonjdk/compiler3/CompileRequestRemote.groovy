...
class CompileRequestRemote implements CompilerRequest {
    ...
    GroovyCompilerReply compile(GroovyCompilerParams params) {
        params.classNameRunnerWithParams.each {
            RunnableWithParamsFactory.runClRefClassloader(it, classLoader12, params)
        }
...
//        GroovyClassLoader cl = JrrClassUtils.currentClassLoaderGroovy
        ...
        compilerReply.groovyAstMethodsAddedTo = groovyCompiler.astTransformationSetPropsMethod.adedTo
        compilerReply.groovyResolvedClasses = groovyCompiler.resolvedClasses
        compilerReply.groovyFailedResolvedClasses = groovyCompiler.failedResolvedClasses
        compilerReply.groovyAstMethodsSkipped = groovyCompiler.astTransformationSetPropsMethod.skipped
