...
class AddSettings2 implements Runnable {
    ...
    void runImpl() {
        ...
        GroovyMethodRunnerParams.gmrp.addFilesToClassLoader.add(AddSettings1.buildFile(SharedFolderSettingsEnum.invocationFrameworkJar))
        GroovyMethodRunnerParams.gmrp.addL(JrrRunnerPhase2.hostConfigWindowsEnriched,false,this.&addGitRefSupport)
