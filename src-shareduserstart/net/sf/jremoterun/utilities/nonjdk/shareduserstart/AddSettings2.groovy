...
class AddSettings2 implements Runnable  , CallerInfo, CallerInfoGetter  {
    ...
    ClRef ifFrameWoekAdder = new ClRef('net.sf.jremoterun.utilities.nonjdk.classpath.ifframecalc.InfocationFrameworkStructure')
    ClRef defaultClasspathAdder = new ClRef('net.sf.jremoterun.utilities.nonjdk.classpath.DefaultClasspathAdder')


    ClRef extentionMethodsChecker = new ClRef('net.sf.jremoterun.utilities.nonjdk.groovy.ExtentionMethodsChecker')
...
//        adder.addF(new File(AddSettings1.buildFile(SharedFolderSettings.InvocationFramework),"src-frameworkloader"));
        RunnableWithParamsFactory.runClRef(ifFrameWoekAdder, [adder, BaseDirAdded.buildFile(SharedFolderSettingsEnum.InvocationFramework)])
        RunnableWithParamsFactory.runClRef(gitAdder77, [adder, BaseDirAdded.buildFile(SharedFolderSettingsEnum.gitDir)])
