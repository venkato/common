...
class IdeaInit5 extends InjectedCode {
    ...
    static ClRef init7 = new ClRef('net.sf.jremoterun.utilities.nonjdk.idea.init2.IdeaInit7')
    ...
    void initImpl(Object o) {
        List list = o as List
        File gitBaseDir =(File) list.get(0)
        assert gitBaseDir.exists()
        File logDir =(File) list.get(1)
        if(logDir==null){
    ...
    static void initImpl2(File gitBaseDir,File logDir){
        ...
        RunnableFactory.runRunner init7
    }
