...
class SettingsRef {
    ...
    public
    static ToFileRef2 location = new  FileToFileRef( new File(  net.sf.jremoterun.utilities.groovystarter.JrrStarterVariables2.getInstance().filesDir,"idea/libmanager.groovy"));

    public
    static ToFileRef2 locationEdit = new  FileToFileRef( new File(  net.sf.jremoterun.utilities.groovystarter.JrrStarterVariables2.getInstance().filesDir,"idea/libmanager_edit.groovy"));
