...
//    b.add new File(NikLdnInitFirstSettings.ideaProductDir, "plugins/java/lib/jps-builders.jar")
//    b.add new File(NikLdnInitFirstSettings.ideaProductDir, "plugins/gradle/lib/gradle.jar")
//    b.add new File(NikLdnInitFirstSettings.ideaProductDir, "plugins/gradle/lib/gradle-tooling-extension-api.jar")
//    b.add new File(NikLdnInitFirstSettings.ideaProductDir, "plugins/gradle/lib/gradle-tooling-extension-impl.jar")
//    b.add new File(NikLdnInitFirstSettings.ideaProductDir, "plugins/gradle-dependencyUpdater/lib/gradle-dependencyUpdater.jar")
