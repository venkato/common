...
@CompileStatic
class ExprEditorIdea extends ExprEditor {
    ...
    ExprEditorIdea(String ideaPluginId) {
...
if("${ideaPluginId}".equals(getPluginId().toString() ) ) {
    ...
    \$_ = loadClassInsideSelf(name, fileName, packageNameHash, forceLoadFromSubPluginClassloader);
}
"""
        }else {
            super.edit(m)
