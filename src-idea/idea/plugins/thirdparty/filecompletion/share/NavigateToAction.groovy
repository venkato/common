...
import idea.plugins.thirdparty.filecompletion.jrr.a.actions.openfile.NavigateToActionImpl
import net.sf.jremoterun.utilities.JrrClassUtils

@CompileStatic
class NavigateToAction extends DeligateAction {
    ...
    public NavigateToAction() {
        super(new NavigateToActionImpl())
        if (thisObject == null) {
            thisObject = this;
        } else {
