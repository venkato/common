...
class ReloadClassConnectionPanel implements ReloadClassSettingsI {
    ...
    void addJmxLocalhostConnections(List<net.sf.jremoterun.utilities.nonjdk.jmx.JmxLocalhostConnections> connections) {
        connections.each {
            addToMap(it.name(), it)
        }
    }
    ...
    RedefineClassI receiveConnectionDefault(String text) {
        ...
        if (handle instanceof net.sf.jremoterun.utilities.nonjdk.jmx.JmxLocalhostConnections) {
            net.sf.jremoterun.utilities.nonjdk.jmx.JmxLocalhostConnections localhostConnection = (net.sf.jremoterun.utilities.nonjdk.jmx.JmxLocalhostConnections) handle;
