...
//        GrVariable grVariable = varRef as GrVariable
    ...
    private void testNotUsed() {
        ...
        JrrJavassistUtils.findMethodByCount(clazz, null, "", 1); //NOFIELDCHECK

        Class class2 = com.intellij.idea.IdeaLogger;
        ClRef clRef2 = new ClRef('com.intellij.idea.IdeaLogger')
        JrrJavassistUtils.findMethodByCount(class2, null, "logErrorHeader", 1); //NOFIELDCHECK
        JrrJavassistUtils.findMethodByCount(clRef2, null, "logErrorHeader", 1); //NOFIELDCHECK
        JrrJavassistUtils.findMethodByCount(this.getClass(), null, "findPsiClass2", 1); //NOFIELDCHECK
    }
