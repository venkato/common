...
//        GrVariable grVariable = varRef as GrVariable
    ...
    private void testNotUsed() {
        ...
        JrrJavassistUtils.findMethod(class2, null, "logErrorHeader", 1);
        JrrJavassistUtils.findMethod(clRef2, null, "logErrorHeader", 1);
        JrrJavassistUtils.findMethod(this.getClass(), null, "findPsiClass2", 1);
    }
