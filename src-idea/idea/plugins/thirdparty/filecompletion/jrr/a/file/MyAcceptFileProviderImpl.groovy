...
//        PsiNewExpression newExpression = (PsiNewExpression) parent
    ...
    static ChildFileLazy findFileFromVarGeneric(final PsiElement varRef) {
        ...
        if (varRef instanceof GrSafeCastExpression) {
            return new FileToFileRef(resolveFileFromSafeCast(varRef))
        }
...
//        Object fieldValue = FieldResolvedDirectly.fieldResolvedDirectly.resolveValue3(className1, fieldName);
...
//        CustomObjectHandler handler = MavenDefaultSettings.mavenDefaultSettings.customObjectHandler
//        if(handler==null){
//            throw new IllegalStateException("customObjectHandler was not set for ${res1}")
//        }
        if(!addSuffix) {
            return res1
        }
...
//        if (res1 instanceof File) {
//            return new File(res1, suffixFile)
//        }
//        if (res1 instanceof ChildFileLazy) {
//            ChildFileLazy childFileLazy = (ChildFileLazy) res1;
//            return handler.resolveToFileIfDownloaded(childFileLazy.childL(suffixFile));
//        }
//        throw new IllegalStateException("unsupported ref ${res1} ${suffixFile}")
