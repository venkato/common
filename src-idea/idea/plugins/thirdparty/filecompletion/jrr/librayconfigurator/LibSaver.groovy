...
import net.sf.jremoterun.utilities.nonjdk.store.Writer7Sub
...
class LibSaver {
    ...
    static MethodClosure addSourceFileMethod = (MethodClosure) (Closure) AddFilesWithSourcesI.&addSourceF

    static MethodClosure addSourceCustomMethod = (MethodClosure) (Closure) AddFilesWithSourcesI.&addSourceS
...
//        String classpath2 = strings.join('\r\n')
    ...
    @Deprecated
    String saveClassPath7Old(List files, List sources) throws Exception {
        Writer3 writer3 = new Writer7Sub(AddFilesToClassLoaderGroovy)
        assert files != null
...
//        writer3.body.addAll calculatorGroovy.buildVar(writer3)
        ...
        writer3.body.addAll(sources.collect { convertSourceEl(it, writer3) })
        writer3.body.add "}" as String
        writer3.body.add "" as String


//        writer3.body.addAll(files.collect {
//            calculatorGroovy.convertEl(it, writer3)
//        })
