...
import net.sf.jremoterun.utilities.nonjdk.classpath.refs.starter.refs.JrrConfigDir2ToFileRef
...
class IdeaRuntimeClassRefrences {
    ...
    static void addReferences(){
        ...
        FieldResolvedDirectly.fieldResolvedDirectly.addDirectEnumClass(JrrConfigDir2ToFileRef)
