...
//        editSettings.setEnabled(!SettingsRef.locationEdit.exists())
    ...
    private createTemplate3() {
        ...
        if (pass) {
            ...
            List classes2 = [JrrStarterJarRefs2.jrrassist, JrrStarterJarRefs.jrrutilitiesOneJar, JrrClassLocationRefs.JrrUtils1, JrrClassLocationRefs.JavaVMClient1]
    ...
    private boolean editSetttingssImpl() {
        ...
        if (SettingsRef.getLocation2().resolveToFile().exists()) {
            FileUtilsJrr.copyFile(SettingsRef.getLocation2().resolveToFile(), SettingsRef.locationEdit.resolveToFile())
            return true
        }
