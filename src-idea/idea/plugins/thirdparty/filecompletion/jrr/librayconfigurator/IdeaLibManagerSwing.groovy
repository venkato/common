...
//        editSettings.setEnabled(!SettingsRef.locationEdit.exists())
    ...
    private createTemplate3() {
        ...
        if (pass) {
            ...
            List<JrrClassLocationRefs> classes2 = [JrrClassLocationRefs.JrrUtilities1, JrrClassLocationRefs.JrrClassUtils1, JrrClassLocationRefs.JrrUtils1, JrrClassLocationRefs.JavaVMClient1]
