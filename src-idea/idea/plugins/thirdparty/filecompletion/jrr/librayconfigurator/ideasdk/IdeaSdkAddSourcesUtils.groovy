...
import idea.plugins.thirdparty.filecompletion.jrr.librayconfigurator.LibManager33;
...
//    ]
    ...
    static boolean isSdkMatched(com.intellij.openapi.projectRoots.Sdk sdk){
        return sdk.getSdkType().getClass().getName() == ideaJdkCl.className
    }
    ...
    static void addMavenIdsSourcesToIdeaSdk(List items) {
        ...
        LibManager3.addCustomAny(read, new NewValueListener<LibConfigurator8>() {
            @Override
    ...
    static void addSourcesToIdeaSdk() {
        IdeaSdkToLibAdapterRead read = new IdeaSdkToLibAdapterRead()
        read.projectJdk = findIdeaSdk()
        LibItem libItem = new LibItem(read,null);
        LibManager33 manager3 = new LibManager33(){
