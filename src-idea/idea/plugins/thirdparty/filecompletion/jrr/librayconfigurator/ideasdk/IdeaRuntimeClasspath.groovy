...
class IdeaRuntimeClasspath {
    ...
    public static List<String> ignoreFiles = ['log4j.jar',
                                              ...
                                              '3rd-party-rt.jar', 'byte-buddy-agent.jar',
                                              'groovy.jar', 'error-prone-annotations.jar', 'grpc-netty-shaded.jar',
                                              '', 'junit.jar', 'junit4.jar', 'junixsocket-core.jar', 'lz4-java.jar',
                                              'protobuf.jar', '', '', '', '', '',
                                              '', '', '', '', '', '',
    ];
    ...
    public static List<String> startwithIgnore = ['oro-', 'netty-', 'nanoxml-', 'miglayout-', 'jsch-', 'jaxb-', 'batik-', 'netty-', 'cli-',
                                                  ...
                                                  'guava-', 'gson-', 'nosyncbuilder-', 'protos-', 'xercesImpl-', 'aapt2-', 'jsonpath.jar',
                                                  'jnr-', 'jffi-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-',]
    ...
    public static List addMavenIds = [
            ...
            new MavenId('com.h2database:h2-mvstore:2.2.224'),
    ]
...
//        mavenId2EnumConverter.filesAndMavenIds = filesAndMavenIds
    ...
    void createMavenId2EnumConverter() {
        ...
        mavenId2EnumConverter.writer7Sub.classNameGenerated = generatedClassNameIdea
