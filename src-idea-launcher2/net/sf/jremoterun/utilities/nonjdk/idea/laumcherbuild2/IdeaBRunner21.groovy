...
class IdeaBRunner21 extends InjectedCode {
    ...
    public
    static ClRef ifFrameWoekAdder = new ClRef('net.sf.jremoterun.utilities.nonjdk.classpath.ifframecalc.InfocationFrameworkStructure')
    ...
    static void f1(File ifBaseDir) {
        ...
        RunnableWithParamsFactory.runClRef(ifFrameWoekAdder, [adder, ifBaseDir])

    }

    /**
     * @see net.sf.jremoterun.utilities.nonjdk.idea.laumcherbuild.IdeaBuilderAddGroovyRuntime#addUrlToCl
     */
    void usedIn(){
        new MethodRef(new ClRef('jdk.internal.loader.BuiltinClassLoader'),'appendClassPath',1)
    }
}
