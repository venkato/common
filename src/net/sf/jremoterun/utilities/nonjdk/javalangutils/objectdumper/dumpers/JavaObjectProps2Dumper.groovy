...
//        JrrClassUtils.getFieldValue(cl,'')
    ...
    void handleField(Object obj, PropertyDescriptor propertyDescriptor1, ObjectDumperProvider dumperProvider,Map<String, Object> r ){
        ...
        if (value3 == null) {
            ...
            try {
                String str = convertValueToStr(obj, propertyDescriptor1, dumperProvider, value3)
                r.put(name1, str)
            } catch (Throwable e) {
    ...
    String convertValueToStr(Object obj, PropertyDescriptor field1, ObjectDumperProvider dumperProvider, Object value3) {
        if(value3!=null) {
