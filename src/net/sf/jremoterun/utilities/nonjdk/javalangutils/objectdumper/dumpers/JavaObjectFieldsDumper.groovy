...
//    public boolean acceptStaticFields = false
    ...
    JavaObjectFieldsDumper() {
        objectFieldsReceiver.ignoreAnnotation1=IgnoreFieldDumper
    }

    JavaObjectFieldsDumper(Collection<FieldRef> ignoreFields) {
        objectFieldsReceiver.ignoreAnnotation1=IgnoreFieldDumper
        objectFieldsReceiver.addIgnoreFields( ignoreFields)
    }

    List<Field> fetchFields(Class cl) {
        return objectFieldsReceiver.getFieldsFilteredPublicClass1(cl)
//        List<Field> list1 = []
