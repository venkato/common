...
/**
 * @see net.sf.jremoterun.utilities.nonjdk.str2obj.v2.CommonToString2
 */
@CompileStatic
class ObjectDumperProvider {
    ...
    ObjectDumperProvider(Collection<FieldRef> ignoreFields) {
        this(new JavaObjectFieldsDumper(ignoreFields))
    }
