package net.sf.jremoterun.utilities.nonjdk.javalangutils.uncaughtexecptions
...
public class SimpleUncaughtExceptionHandler implements UncaughtExceptionHandler {
    ...
    public void uncaughtException(final Thread t, final Throwable e) {
        log.severe(t, e);
        net.sf.jremoterun.utilities.JrrUtilitiesShowE.showException("thread " + t.getId() + " " + t.getName(), e);
    }
