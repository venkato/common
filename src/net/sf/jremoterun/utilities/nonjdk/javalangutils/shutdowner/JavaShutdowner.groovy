package net.sf.jremoterun.utilities.nonjdk.javalangutils.shutdowner

import groovy.transform.CompileStatic
import net.sf.jremoterun.utilities.JrrClassUtils
import net.sf.jremoterun.utilities.classpath.ClRef
import net.sf.jremoterun.utilities.nonjdk.javalangutils.thread.JrrThreadUtils
...
class JavaShutdowner implements Runnable {
    ...
    static void getHooks() {
        hooks = JrrClassUtils.getFieldValue(javaShutdownerHooks, 'hooks') as IdentityHashMap
        hooks4 = (Runnable[]) JrrClassUtils.getFieldValue(javaShutdownerMain, 'hooks')
