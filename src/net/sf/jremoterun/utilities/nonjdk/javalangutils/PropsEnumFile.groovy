...
/**
 * @see net.sf.jremoterun.utilities.nonjdk.windowsos.UserHomeOsGenericClass
  * @see org.apache.commons.lang3.SystemUtils
 */
@CompileStatic
enum PropsEnumFile implements EnumNameProvider, ZeroOverheadFileRef, File2FileRefWithSupportI{
    java_home,
    user_home,
    user_dir,
    /**
