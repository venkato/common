...
import com.google.api.client.http.apache.v2.ApacheHttpRequestJrr
...
import com.google.cloud.tools.jib.api.JibContainerBuilderOriginJrr
...
//    public JibContainerBuilderOriginJrr b;
    ...
    RegistryClient findTargetRegistryClient(){
        Object r = findResult()
        Future<RegistryClient> f= JrrClassUtils.getFieldValue(r,'targetRegistryClient') as Future<RegistryClient>
        return f.get()
    }
    ...
    List<Image> pullImage(){
        ...
        List<Image> res2 = JrrClassUtils.getFieldValue(res,'images') as List<Image>
        return res2
    }
