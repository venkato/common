...
/**
 * instance of @link{net.sf.jremoterun.utilities.nonjdk.shellcommands.NativeCommand} for one command.  To run same command many time need create many instances.
 * To avoid this use this class.
 */
@CompileStatic
