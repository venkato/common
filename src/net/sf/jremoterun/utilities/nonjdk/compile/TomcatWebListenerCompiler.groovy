...
//        client.adder.addAll GroovyMavenIds.all
        ...
        compilerPure.addInDir IfFrameworkSrcDirs.src.childL(new ClRef('net.sf.jremoterun.utilities.nonjdk.net.tomcat.weblistener.JrrServletContextListener').getClassPath()+'.java')
