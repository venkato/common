...
class IfFrameworkCompiler extends GenericCompiler {
    ...
    public static MavenIdsCollector mavenIdsCollector = new MavenIdsCollector()

    static void addLibs(AddFilesToClassLoaderGroovy adder, CompileRequestClient client){
...
//        adder.add JrrClassLocationRefs.Java11ModuleAccessF1
        adder.addAll mavenIdsCollector.loadMavenIds2 (new IfframeworkClasspath())
...
//        addToolsJar()
    ...
    void zipp(File destJar) {
        ...
        jarArchiver.acceptRejectFilterJar.endWithIgnoreClasses.add '.java'
        try {
