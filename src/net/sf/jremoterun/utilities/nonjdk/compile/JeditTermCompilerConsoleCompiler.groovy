...
//        CustomObjectHandler handler = MavenDefaultSettings.mavenDefaultSettings.customObjectHandler
//        File f = handler.resolveToFileIfDownloaded(GitSomeRefs.jtermGitSpec)
//        if(f==null){


//            CustomObjectHandlerImpl handlerIm = handler as CustomObjectHandlerImpl;
//            handlerIm.cloneGitRepo3.git
//        }else{
//            log.info "checkout already done"
//        }
