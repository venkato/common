...
class TrolCommanderCompilerAux {
    ...
    public static List<? extends MavenIdContains> mavenIds1 = [
            CustObjMavenIds.slf4jApi
            , LatestMavenIds.reload4j
            ...
            , net.sf.jremoterun.utilities.nonjdk.classpath.RstaJars.fifeRtext()
            ...
            , new MavenId('com.google.guava:guava:21.0')
...
//            , GitReferences.pureJavaCom
    ...
    public static List mavenIds2 = [
            ...
            , new MavenId('org.apache.hadoop:hadoop-auth:3.5.0')
            , new MavenId('org.apache.hadoop:hadoop-common:3.5.0')
            , new MavenId('org.apache.hadoop:hadoop-hdfs:3.5.0')
            , new MavenId('com.vmware.photon.controller:photon-vsphere-adapter-sdk:0.6.56')
    ]


    public static List mavenIds = mavenIds1 + mavenIds2 + mavenIds3
