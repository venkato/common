...
import net.sf.jremoterun.utilities.nonjdk.javassist.redefinition.AsmRefResolveRed
...
//    }
    ...
    void fixClResolver() {
        AsmRefResolveRed red = new AsmRefResolveRed()
        red.takeClassFromAnotherLoader(client.loader)
        red.redefineResolveMethod();
    }
