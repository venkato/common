...
public class InternalHttpClientJrr extends CloseableHttpClient  implements Configurable {
    ...
    public void copyPropsFromOtherClient(CloseableHttpClient other){
        execChain = (ClientExecChain) JrrClassUtils.getFieldValueR(clRef, other, "execChain");
        connManager= (HttpClientConnectionManager) JrrClassUtils.getFieldValueR(clRef, other, "connManager");
        routePlanner= (HttpRoutePlanner) JrrClassUtils.getFieldValueR(clRef, other, "routePlanner");
        cookieSpecRegistry= (Lookup<CookieSpecProvider>) JrrClassUtils.getFieldValueR(clRef, other, "cookieSpecRegistry");
        authSchemeRegistry= (Lookup<AuthSchemeProvider>) JrrClassUtils.getFieldValueR(clRef, other, "authSchemeRegistry");
        cookieStore= (CookieStore) JrrClassUtils.getFieldValueR(clRef, other, "cookieStore");
        credentialsProvider= (CredentialsProvider) JrrClassUtils.getFieldValueR(clRef, other, "credentialsProvider");
        defaultConfig= (RequestConfig) JrrClassUtils.getFieldValueR(clRef, other, "defaultConfig");
        closeables= (List<Closeable>) JrrClassUtils.getFieldValueR(clRef, other, "closeables");
    }
