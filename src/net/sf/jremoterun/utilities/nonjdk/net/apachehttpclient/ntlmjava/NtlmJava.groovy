...
public class NtlmJava {
    ...
    long crdHandle(){
        long crdHandle1 = JrrClassUtils.getFieldValue(myAuthSequenceObject,'crdHandle') as long
        return crdHandle1
    }
    ...
    Object statusObject(){
        Object  status1 = JrrClassUtils.getFieldValue(myAuthSequenceObject,'status')
        return status1
    }

    int state(){
        Object  status1 = JrrClassUtils.getFieldValue(myAuthSequenceObject,'state')
    ...
    byte[] getNextToken ( byte[] lastToken){
        ...
        byte[] r = JrrClassUtils.invokeJavaMethod(myAuthSequenceObject,'getNextToken',crdHandle,lastToken,status1) as byte[];
        return r
    }
