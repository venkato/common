...
public class NtlmJava {
    ...
    long crdHandle(){
        long crdHandle1 = JrrClassUtils.getFieldValue(myGetAuthHeaderMethod,'crdHandle') as long
        return crdHandle1
    }
    ...
    Boolean statusObjectValue(){
        ...
        boolean value1 = JrrClassUtils.getFieldValue(st, 'sequenceComplete')
        return value1
    }

    Object statusObject(){
        Object  status1 = JrrClassUtils.getFieldValue(myGetAuthHeaderMethod,'status')
        return status1
    }

    int state(){
        Object  status1 = JrrClassUtils.getFieldValue(myGetAuthHeaderMethod,'state')
    ...
    byte[] getNextToken ( byte[] lastToken){
        ...
        byte[] r = JrrClassUtils.invokeJavaMethod(myGetAuthHeaderMethod,'getNextToken',crdHandle,lastToken,status1) as byte[];
        return r
    }
