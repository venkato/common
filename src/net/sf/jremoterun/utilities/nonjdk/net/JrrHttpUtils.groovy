...
import net.sf.jremoterun.utilities.nonjdk.git.CredentialsProviderWrapper
...
import net.sf.jremoterun.utilities.nonjdk.net.proxynew.JrrHttpRoutePlanner2
...
//    }
    ...
    void addResponseLogger(boolean logAsWarning){
        HttpResponseLogger httpResponseLogger=new HttpResponseLogger()
        assert httpClient1 ==null
        if(logAsWarning){
