...
import net.sf.jremoterun.utilities.nonjdk.net.apachehttpclient.helpers.RedirectStrategyNone
...
//    public SSLContext sslContext;
    ...
    void addNtlmWinNativePrepare() {
        ...
        WindowsCredentialsProvider windowsCredentialsProvider = new WindowsCredentialsProvider(new BasicCredentialsProviderJrr())
