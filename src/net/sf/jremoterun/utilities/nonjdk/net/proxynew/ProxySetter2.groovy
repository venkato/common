...
@CompileStatic
class ProxySetter2 extends ProxySelector implements ProxySelect2I {
...
//    @Deprecated
//    ProxySetter2(String proxyHost, int proxyPort) {
//        this.proxyHost = proxyHost
//        this.proxyPort = proxyPort
//    }

    ProxySetter2(ProxySelectI proxySelectGeneric1, ProxyHostInfo  proxyHostInfo1) {
        //this(proxyHostInfo.proxyHost, proxyHostInfo.proxyPort)
...
//    @Deprecated
//    ProxySetter2(ProxySelectGeneric proxySelectGeneric, String proxyHost, int proxyPort) {
//        this(proxyHost, proxyPort)
//        this.proxySelectGeneric = proxySelectGeneric
//    }
...
//    @Deprecated
//    void setProps() {
//        ProxyStaticMethods.setProxyS(proxyHost, proxyPort)
//        proxySelectGeneric.setNoProxyProp()
//    }
