...
class NTLMAuthenticator implements Authenticator {
    ...
    public NTLMAuthenticator(String userrname, String paword, String domain, String workstation) throws NTLMEngineException {
        this.domain = domain;
    ...
    String doType3(String ntlmMsg3) {
        ...
        ntlmMsg3 = engine.generateType3Msg(userrname, paword, domain, workstation, substring);
