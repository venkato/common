...
class JrrQfDataHolder {
    ...
    @Deprecated
    public static char fixMsgNativeSep = net.sf.jremoterun.utilities.nonjdk.quickfixsender.QuickFixMsgUtils.fixMsgNativeSep;
...
//    public DefaultSessionScheduleFactory sessionScheduleFactory
    ...
    public SeqNumberAutoFixer fixMsgAutoFixer = new SeqNumberAutoFixer()
