...
public class Log4j2Utils {
    ...
    //    public static volatile CompositeFilter compositeFilterFirst = CompositeFilter.createFilters(null);
...
//            filterOrigin = loggerConfig.getFilter();
//            System.out.println("origin filert "+ filterOrigin);
//            org.apache.logging.log4j.core.Filter[] fi = {compositeFilterFirst, filterOrigin};
//            compositeFilter =  CompositeFilter.createFilters(fi);
//            JrrClassUtils.setFieldValue(loggerConfig, "filter", compositeFilter);
//        }
...
//		loggerConfig.start();
    ...
    public static void suppressIsAppenderCalled() throws Exception {
        ...
        CtMethod method = JrrJavassistUtils.findMethodByCount(clazz, ctClazz, "isRecursiveCall", 0);
