...
//        addClRef(new ClRef('net.sf.jremoterun.utilities.nonjdk.sshsup.hierynomus.SSHPacketHandlerProxy'));
        ...
        addClRef(new ClRef('com.intellij.internal.statistic.eventLog.StatsAppConnectionSettings'));
...
//        addClRef(new ClRef('sun.security.ssl.SSLSocketImpl'));
        ...
        addClRef(new ClRef("java.util.function.BiPredicate"));
        addClRef(new ClRef("java.util.function."));
