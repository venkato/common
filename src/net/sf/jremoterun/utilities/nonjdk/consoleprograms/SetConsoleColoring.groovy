...
class SetConsoleColoring {
    ...
    static void setConsoleColoringWithOutRedirect(File outFile,int maxDepth) {
        ...
        NewValueListener<Throwable> occured = GroovyMethodRunnerParams.instance.onExceptionOccured;
        if (occured.class == PrintExceptionListener) {
            GroovyMethodRunnerParams.instance.onExceptionOccured = printExceptionColorListener.newInstance3() as NewValueListener<Throwable>
        } else {
