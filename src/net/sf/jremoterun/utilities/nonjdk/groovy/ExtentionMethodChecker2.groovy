...
/**
 * @see net.sf.jremoterun.utilities.nonjdk.langimprovetesters.ExtMethodsTester
 */
@CompileStatic
class ExtentionMethodChecker2 {
    ...
    static void check() {
        File f = GitSomeRefs.commonUtil.childL('resources/tcpmon/extMethodTester.groovy').resolveToFile();
