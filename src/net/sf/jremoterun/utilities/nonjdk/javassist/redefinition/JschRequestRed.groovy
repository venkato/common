...
class JschRequestRed extends  RedefinitionBase{
    ...
    public static net.sf.jremoterun.utilities.classpath.ClRef clRef1= new ClRef('com.jcraft.jsch.RequestRequest');
...
//        Class clazz = com.jcraft.jsch.Request
        ...
        CtBehavior method1 = JrrJavassistUtils.findMethod(clRef1, cc, "write", 1);
