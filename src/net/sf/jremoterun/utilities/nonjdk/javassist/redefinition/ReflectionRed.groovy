...
class ReflectionRed extends RedefinitionBase {
    ...
    void redefineSunReflection() throws Exception {
        ...
        final CtMethod method1 = JrrJavassistUtils.findMethod(clRef,cc,'ensureMemberAccess',4)
        method1.setBody("{}")
        final CtMethod method2 = JrrJavassistUtils.findMethod(clRef, cc,'verifyMemberAccess',4)
