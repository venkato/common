...
public class ClassRedefintions {
    ...
    static void disableJarVerifierIfCan() throws Exception {
        new net.sf.jremoterun.utilities.nonjdk.javassist.redefinition.JarManifestRed().disableVerifierIfCan()
    }
    ...
    static void redifineSecurityManager() throws Exception {
        new SystemRed().redefineSecurityManagerIfCan()
    }
