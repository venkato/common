...
import net.sf.jremoterun.utilities.nonjdk.store.ListStore2
...
/**
 * @see net.sf.jremoterun.utilities.nonjdk.ziputil.unzrchivecommon.UnarchiveCommon
 */
@Deprecated
@CompileStatic
class Unpack {
    ...
    Unpack(File configFile, File baseDir,File backupDir) {
        ListStore2 config =new ListStore2(configFile)
        List<PackInfo> packInfos = (List)config.loadsettings()
