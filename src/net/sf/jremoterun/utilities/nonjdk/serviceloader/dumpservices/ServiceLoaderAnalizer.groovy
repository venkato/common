...
//        new File(dir,'rawLatest.groovy').text = newDataRaw
    ...
    void saveMutiReleaseToFile(File dir, int rotateCount){
        ...
        String newData = mapStoreMutiRelease.save3(new1)
        ...
        if(goldenDataDataFIle.exists()) {
            GroovyConfigLoader2 configLoader2 = RunnableFactory.groovyClassLoader.parseClass(goldenDataDataFIle).newInstance()
