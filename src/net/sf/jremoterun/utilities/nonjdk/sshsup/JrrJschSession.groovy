...
class JrrJschSession extends JrrJschSessionOriginal {
    ...
    void setPreferredAuth(SshAuthType authType) {
        setConfig("PreferredAuthentications", authType.customName);
    }
...
//    }
    ...
    Map<String, Object> fetchProposalsJson(FieldRef fieldName) {
        ...
        return (Map)  new ObjectDumperProvider( new JavaObjectPropsDumper([SshProposalsParser.packetField])).dumpObject(obj)
    }
