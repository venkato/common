...
//        Object negotiatedAlgorithms = JrrClassUtils.getFieldValue(kexer,'clientProposal')
    ...
    void dumpMainParamsToFile(File folder, String fileSuffix ,int rotateCount){
        ...
        new TextConfigLoader(f,rotateCount).saveIfNeeded(params1)
    }
...
//        Map<String, Object> clientProposal =
        ...
        r.put(SshjDumpParams.proposalClient,new ObjectDumperProvider([SshProposalsParser.packetField]).dumpObject(getClientProposals()))
        r.put(SshjDumpParams.proposalServer,new ObjectDumperProvider([SshProposalsParser.packetField]).dumpObject(getServerProposals()))
