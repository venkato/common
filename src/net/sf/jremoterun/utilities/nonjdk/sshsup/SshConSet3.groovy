...
//        sftpUtils.close()
    ...
    void createNewSftpConn(SftpUtils sftpUtils2) {
        ...
        if (sshKey == null) {
            assert passwordReceiver != null
            PasswordAuthentication pwd = new PasswordAuthentication();
            pwd.setPassword(passwordReceiver.readPassword(this))
    ...
    SftpUtils createSftpUtils() {
        ...
        SftpUtils sftpUtils2 = createSftpUtilsInstanceOnly()
    ...
    SftpUtils createSftpUtilsInstanceOnly() {
