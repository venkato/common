...
//    public static SshConSet2 defaultSet = new SshConSet2();
    ...
    public SshPasswordReceiverI passwordReceiver = new SshPasswordReceiverDefault(this)
    public File sshKey = defaultSshKey
    public File knownHosts = defaultKnownHosts

    @Override
    String toString() {
        return "${user}@${host} , sshkey = ${sshKey}, password set ? ${passwordReceiver.isPasswordSet()}, ${knownHosts}"
    }
}
