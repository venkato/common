...
public class MyTextArea extends RSyntaxTextArea {
	...
	public static int maxEditCountDefault = 5;
	public int maxEditCount = maxEditCountDefault;
...
//		super.setSelectionEnd(0);
	...
	public java.util.List<JMenuItem> predefinedMenus = []
