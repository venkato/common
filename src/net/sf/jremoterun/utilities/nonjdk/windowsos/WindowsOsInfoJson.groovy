...
class WindowsOsInfoJson {
    ...
    public ObjectDumperProvider javaObjectPropsDumper = new ObjectDumperProvider( [new FieldRef(new ClRef(oshi.hardware.common.AbstractNetworkIF),'networkInterface')]);
