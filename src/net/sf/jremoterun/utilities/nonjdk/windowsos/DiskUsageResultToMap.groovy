...
//    public static long oneMg = BytesDivider.mb.divider
//    public static long tenMg = long.valueOf(1_000_000)
//    public static long oneGg = BytesDivider.gb.divider
...
//    public DecimalFormat decimalFormatDecimal = new DecimalFormat('#.##')
    ...
    String writeSize(long bd) {
        return bytesToHumanConverter.convertHuman(bd)
//        if (bd > oneGg) {
...
//        return "${decimalFormatDecimal.format(divide1)} mb"
    ...
    boolean isNeedAggregateFile(DiskUsageResult e){
        return e.totalSize < BytesDivider.mb.multBy(needAggregateFilesSizeLessInMg)
    }
