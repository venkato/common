...
import net.sf.jremoterun.utilities.nonjdk.classpath.ifframecalc.InfocationFrameworkStructure
import net.sf.jremoterun.utilities.nonjdk.javalangutils.JavaVersionChecker
    ...
    File resolveToFileIfDownloaded(Object object) {
        ...
        switch (object) {
            ...
            case { object instanceof IfFrameworkResourceDirs }:
                ...
                log.info("need define ${InfocationFrameworkStructure.getSimpleName()}.ifDir to resolve : ${object}")
                return null;
...
//        }
    ...
    public List<? extends Class> badObjects = [Boolean, Integer, Short, Long,]

    void checkForBadObject(Object object) {
        if (object == null) {
            throw new NullPointerException("object is null")
        }
        Class clazz = object.getClass()
        if (badObjects.contains(clazz)) {
            throw new IllegalArgumentException("${clazz.getName()} ${object}")
        }
    }
