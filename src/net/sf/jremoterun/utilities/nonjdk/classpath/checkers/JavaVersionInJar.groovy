...
import net.sf.jremoterun.utilities.nonjdk.classpath.refs.TomcatEmbedMavenIds
...
//        ignoredMavenIds.add net.sf.jremoterun.utilities.nonjdk.classpath.refs.NettyMavenIds.testsuite_osgi
        ignoredMavenIds.add net.sf.jremoterun.utilities.nonjdk.classpath.refs.NettyMavenIds.codec
        ...
        ignoredMavenIds.add net.sf.jremoterun.utilities.nonjdk.classpath.refs.MaryDependentMavenIds.opennlp_tools
        ...
        ignoredMavenIds.add  net.sf.jremoterun.utilities.nonjdk.classpath.refs.LatestMavenIds.xtextEclipseLangServerProtoclIntegration1
        ...
        ignoredMavenIds.add  net.sf.jremoterun.utilities.nonjdk.classpath.refs.LatestMavenIds.browserTester
        ignoredMavenIds.add  net.sf.jremoterun.utilities.nonjdk.classpath.refs.NexusSearchMavenIds.xpp3XmlParser
        ignoredMavenIds.add net.sf.jremoterun.utilities.nonjdk.classpath.refs.TomcatDiffMavenId.tomcat10
        ignoredMavenIds.add TomcatEmbedMavenIds.embed_core
        ignoredMavenIds.add  new MavenId('net.sf.sevenzipjbinding:sevenzipjbinding-all-platforms:9.20-2.00beta')
        ignoredMavenIds.add  new MavenId('com.mashape.unirest:unirest-java:1.4.9')
        ignoredMavenIds.add  new MavenId('org.apache.hadoop:hadoop-auth:3.5.0')
        ignoredMavenIds.add  new MavenId('org.apache.hadoop:hadoop-common:3.5.0')
        ignoredMavenIds.add  new MavenId('org.apache.hadoop:hadoop-hdfs:3.5.0')
    }
