...
class GroovyMethodsChecker {
    ...
    public List<String> methodsToCheck = GroovyMethodsEnum.values().collect { it.getNameAndDescriptor() }

    public String nameAndDescriptorOne = GroovyMethodsEnum.setProperty.getNameAndDescriptor()
...
//        log.info2(existedMethods.join('\n'))
        ...
        assert existedMethods.contains(nameAndDescriptorOne)
        assert existedMethods.containsAll(methodsToCheck)
