...
class IdePreloadAndDumper {
    ...
    public int periodInSec = DurationConstants.oneHour.timeInSecInt;
    ...
    public long startUpDumperDelayFirstTimeInSec = 120
    public long startUpDumperDelayInSec = 1

//    IdePreloadAndDumper() {
//    }

    public IdePreloadAndDumper(IdePluginsClassloaderInfo idePluginsClassloaderInfo, JavaProcessInfoE e) {
    ...
    void init() {
        ...
        long startUpDumperDelayInSecLocal = javaProcessInfoE.getClassesDumpFile().exists() ? startUpDumperDelayInSec : startUpDumperDelayFirstTimeInSec
        dumpLoadedClassesIde = new DumpLoadedClassesIde(javaProcessInfoE.getClassesDumpFile(), periodInSec, idePluginsClassloaderInfo, startUpDumperDelayInSecLocal)
    ...
    void loadClass3(ClassLoader classLoader2, String className1) {
        ...
        idePluginsClassloaderInfo.loadClass3(classLoader2, className1)
    }
