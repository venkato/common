...
abstract class CsvComparator {
     ...
     */
    public List<Integer> skipColumns = []


    /**
     * Columns id starts with 0
     */
    public List<Integer> columnsIds = []

    public CSVReader csvReader
    public List<String> header
    public List<String> currentLine;

    public LineCountStat lineCountStat = new LineCountStat()
    ...
    boolean isNeedPrintProgress(long linesRead) {
        return lineCountStat.isNeedPrintProgress(linesRead)
    }
