...
public class SocketRR extends Thread {
    ...
    public SocketRR(final Connection c, final SocketI inputSocket,
                    final InputStream inputStream, final SocketI outputSocket,
...
//            final int saved = 0;
            ...
            a: for (;;) {
                ...
                String newData = myConnection.listener.tcpMonSettings.createStringFromBytes(this,buffer, 0, len);
                ...
                // if (showMsgData == null) {
                {
                    ...
                    if (myConnection.listener.filterCheckBox.isSelected()) {
                        if (showMsgData == null) {
                            ...
                            usesss = showMsgData.isShowMsg(buffer, 0,
                                    len, newData);
                        }
                    } else {
                        usesss = true;
