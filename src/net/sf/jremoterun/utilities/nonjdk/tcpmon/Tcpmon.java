...
public class  Tcpmon {
	...
	public Tcpmon(File addHostScript) throws IOException {
		JrrUtilitiesFile.checkFileExist(addHostScript);
	...
	public static void setTextArea(final MyTextArea inputText) {
