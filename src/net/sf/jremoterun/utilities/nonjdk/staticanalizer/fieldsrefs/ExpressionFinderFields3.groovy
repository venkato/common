            ...
            if (method1 instanceof org.codehaus.groovy.ast.expr.ConstantExpression) {
                ...
                if (type1 != null) {
                    ...
                    if (staticFieldType != null) {
                        ...
                        if (staticFieldType == StaticFieldType.setFieldValue || staticFieldType == StaticFieldType.getFieldValue || staticFieldType == StaticFieldType.setFieldValueR || staticFieldType == StaticFieldType.getFieldValueR || staticFieldType == StaticFieldType.findField
                                || staticFieldType == StaticFieldType.invokeJavaMethodR || staticFieldType == StaticFieldType.invokeJavaMethod || staticFieldType == StaticFieldType.invokeJavaMethod2 || staticFieldType == StaticFieldType.invokeJavaMethod2R || staticFieldType == StaticFieldType.findMethodByCount || staticFieldType == StaticFieldType.findMethodByParamTypes1
                                || staticFieldType == StaticFieldType.findMethodByParamTypes2 || staticFieldType == StaticFieldType.findMethodByParamTypes3 || staticFieldType == StaticFieldType.findMethodByParamTypes4 || staticFieldType == StaticFieldType.runMainMethod) {
                            ...
                            if (expressions1.size() > 1) {
                                ...
                                if (expression11 instanceof org.codehaus.groovy.ast.expr.ConstantExpression) {
                                    ...
                                    ClRef expression1Obj = resolveClRefExpression(expressions1[0])
                                    if (staticFieldType == StaticFieldType.setFieldValue || staticFieldType == StaticFieldType.getFieldValue || staticFieldType == StaticFieldType.findField || staticFieldType == StaticFieldType.setFieldValueR || staticFieldType == StaticFieldType.getFieldValueR) {
                                        onElementFound(new FieldRef(expression1Obj, constantExpression2.getText()), expression)
                                    }
                                    if (staticFieldType == StaticFieldType.invokeJavaMethod || staticFieldType == StaticFieldType.invokeJavaMethodR|| staticFieldType == StaticFieldType.invokeJavaMethod2R|| staticFieldType == StaticFieldType.invokeJavaMethod2) {
