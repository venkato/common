...
class EclipseProxyDataImpl implements EclipseProxyData {
    ...
    String user
    ObjectHolder<String> password1

    ProxyHostInfo proxyHostInfo

    EclipseProxyDataImpl(ProxySelectI proxySelect, ProxyTrackerI proxyTracker, String user, ObjectHolder<String> password,ProxyHostInfo proxyHostInfo) {
