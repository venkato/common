 ...
 * #GuavaApacheHttpTransportJrr(HttpClient)} constructor to override the Apache HTTP Client used. Please
 * read the <a
 ...
 * @since 1.30
 */
public class GuavaApacheHttpTransportJrr extends GuavaHttpTransportJrr {
     ...
     * @since 1.30
     */
    public GuavaApacheHttpTransportJrr() {
     ...
     * @since 1.30
     */
    public GuavaApacheHttpTransportJrr(HttpClient httpClient) {
     ...
     */
    @Beta
    public GuavaApacheHttpTransportJrr(HttpClient httpClient, boolean isMtls) {
        this.httpClient = httpClient;
        this.isMtls = isMtls;
    }
     ...
     * #GuavaApacheHttpTransportJrr()} constructor.
     *
     * <p>Settings:
     *
     * <ul>
    ...
    /**
     * Creates a new Apache HTTP client builder that is used by the {@link #GuavaApacheHttpTransportJrr()}
     * constructor.
     *
     * <p>Settings:
     *
    ...
    @Override
    protected ApacheHttpRequestJrr buildRequest(String method, String url) {
        checkForStop();
        ...
        ApacheHttpRequestJrr apacheHttpRequestJrr = buildRequestJrr(requestBase);
        return apacheHttpRequestJrr;
    }

    protected ApacheHttpRequestJrr buildRequestJrr(HttpRequestBase requestBase) {
        checkForStop();
        return new ApacheHttpRequestJrr(httpClient, requestBase, this);
    }
    ...
    protected ApacheHttpResponseJrr createApacheHttpResponseJrr(ApacheHttpRequestJrr apacheHttpRequestJrr) throws IOException {
        checkForStop();
        try {
            return new ApacheHttpResponseJrr(apacheHttpRequestJrr.request, httpClient.execute(apacheHttpRequestJrr.request));
        }catch (Exception e){
            onException3(e);
            throw e;
        }
    ...
    protected RequestConfig buildRequestConfigJrr(ApacheHttpRequestJrr apacheHttpRequestJrr) {
        checkForStop();
        configureApacheHttpRequest(apacheHttpRequestJrr.requestConfig);
        RequestConfig buildApache = apacheHttpRequestJrr.requestConfig.build();
        return buildApache;
    }
    ...
    public void onException3(Exception e) {
    }
}
