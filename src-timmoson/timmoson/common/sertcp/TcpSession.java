...
//	public static WeakHashMap<TcpSession, Object> tcpSessions= new WeakHashMap();
	...
	public volatile SocketI socket;
	...
	public static TcpSession buildTcpSession(SocketI socket) throws IOException {
...
//		tcpSessions.put(tcpSession, TcpSocketLlistener.object);
	...
	public static TcpSession buildSslTcpSession(SocketI socket) throws IOException {
		TcpSession tcpSession = new TcpSession();
		tcpSession.socket = socket;
		tcpSession.updateLastAccessRead();
		tcpSession.updateLastAccessWrite();
