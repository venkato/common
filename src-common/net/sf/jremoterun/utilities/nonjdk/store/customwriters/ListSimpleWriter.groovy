...
class ListSimpleWriter implements CustomWriter<List> {
    ...
    @Override
    String save(Writer3Import writer3, ObjectWriter objectWriter, List list) {
        return save2(writer3, objectWriter, list)
    }

    String save2(Writer3Import writer3, ObjectWriter objectWriter, List list) {
        if (list.size() == 0) {
            return '[]'
        }
    ...
    List<String> convertToString(Writer3Import writer3, ObjectWriter objectWriter, List list){
        int counttt = -1;
    ...
    String writeEl(Writer3Import writer3, ObjectWriter objectWriter, Object el) {
