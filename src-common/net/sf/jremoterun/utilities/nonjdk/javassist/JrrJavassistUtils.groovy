...
'''
    ...
    static CtMethod findMethod(final MethodRef methodRef, final CtClass cc){
        if(methodRef.clazz==null){
            return findMethod(methodRef.clRef.getClRef(),cc,methodRef.methodName,methodRef.paramsCount)
        }
        return findMethod(methodRef.clazz,cc,methodRef.methodName,methodRef.paramsCount)
    }
