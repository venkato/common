...
class LangUtils {
    ...
    static Map<String,String> getEnvSettings(){
        Map m = JrrClassUtils.getFieldValue(new ClRef('java.lang.ProcessEnvironment'),'theCaseInsensitiveEnvironment') as Map
        return m
    }
