...
class JrrSwingUtils {
    ...
    static void setWindowVisibleStartWith(String classnameStartwith, boolean visible1) {
        Collection<Window> windows = JrrUtilities3Swing.findAwtWindows().findAll {
            it.getClass().getName().startsWith(classnameStartwith)
        }
        windows.each {
            it.setVisible(visible1)
        }
    }
