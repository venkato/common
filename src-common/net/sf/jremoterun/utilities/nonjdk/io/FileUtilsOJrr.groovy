...
public class FileUtilsOJrr {
     ...
     */
    public long FILE_COPY_BUFFER_SIZE = 1024 * 1024 * 30;
     ...
     */
    public void copyFile(final File srcFile, final File destFile,
     ...
     * position
     */
    public void doCopyFile(final File srcFile, final File destFile, final boolean preserveFileDate)
            throws IOException {
    ...
    void checkStopFlag(){
        if(stopFlag){
            throw new Exception("stop flag set")
        }
    }

    public volatile boolean stopFlag = false

    void closeQuietly2(Closeable out) {
     ...
     * @since 1.1
     */
    public void copyDirectory(final File srcDir, final File destDir,
                              final boolean preserveFileDate) throws IOException {
    ...
    public void copyDirectory(final File srcDir, final File destDir,
        ...
        if (destDir.getCanonicalPath().startsWith(srcDir.getCanonicalPath())) {
            final File[] srcFiles = listFiles(srcDir,filter)
     ...
     */
    public void checkFileRequirements(final File src, final File dest) throws FileNotFoundException {
        if (src == null) {
            throw new NullPointerException("Source must not be null");
        }
        if (dest == null) {
    ...
    File[] listFiles(final File srcDir, final FileFilter filter) {
     ...
     * @since 1.1
     */
    public void doCopyDirectory(final File srcDir, final File destDir, final FileFilter filter,
     ...
     * @since 2.6
     */
    public void copyToDirectory(final File src, final File destDir) throws IOException {
        if (src == null) {
            throw new NullPointerException("Source must not be null");
        }
        if (src.isFile()) {
     ...
     * @since 2.6
     */
    public void copyToDirectory(final Iterable<File> srcs, final File destDir) throws IOException {
        if (srcs == null) {
