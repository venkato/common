    ...
    static void check(Class toCheck) {
        ...
        if (location == null) {
            ...
            if (string==null||string.contains(cacheFolderName)) {
                net.sf.jremoterun.utilities.JrrUtilitiesShowE.showException("Cached classes used : ${string}", new Exception("Cache used : ${string} for ${toCheck.name}"))
            }
        }
    }
