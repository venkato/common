...
class ClassPathInit3  extends InjectedCode{
    ...
    public static ClRef gitRefSupport = new ClRef('net.sf.jremoterun.utilities.nonjdk.classpath.CustomObjectHandlerSetter')
...
//    static  ClassLoader cl = JrrClassUtils.currentClassLoader;
    ...
    static void addGitRefSupport(AddFilesToClassLoaderCommon adder, File gitRepoBase){
        if(inited){
            ...
            RunnableWithParamsFactory.runClRef(gitRefSupport, [adder, gitRepoBase])
