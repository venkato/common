...
//	static MethodClosure addFileMethod = (MethodClosure)ClassPathCalculatorSup2Groovy.&addF
    ...
    public Writer7Sub writer7Sub = new Writer7Sub(AddFilesToClassLoaderGroovy)
...
//			default:
        ...
        return (String) "${writer7Sub.varNameThis}.${addGenerecMethod.method} ${s}"
//		}
    }
