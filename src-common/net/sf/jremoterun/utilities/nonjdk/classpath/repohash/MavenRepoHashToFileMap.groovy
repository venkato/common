...
class MavenRepoHashToFileMap {
    ...
    void init(LongTaskInfo longTaskInfo){
        ...
        MavenDefaultSettings.mavenDefaultSettings.mavenFileFinder.getMavenLocalDir2().eachFileRecurse(FileType.FILES, {
            ...
            if (name.endsWith(".jar") && !name.endsWith("-sources.jar")) {
                ...
                if (sha1File.exists()) {
                    ...
                    MavenId mi = mavenCommonUtils.mavenDefaultSettings.mavenFileFinder.detectMavenIdFromFileName(it,false,mavenCommonUtils.fileType)
                    if (mi != null) {
