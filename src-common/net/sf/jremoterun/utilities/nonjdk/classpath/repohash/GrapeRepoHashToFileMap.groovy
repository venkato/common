...
class GrapeRepoHashToFileMap {
    ...
    public
    static ToFileRef2 noMavenIdFilesJsonDefault = new  FileToFileRef( new File(  net.sf.jremoterun.utilities.groovystarter.JrrStarterVariables2.getInstance().filesDir,"ivy_hash_cache2.json"))
