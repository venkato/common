...
//    eclipseJavaCompiler('org.eclipse.jdt.core.compiler:ecj:4.6.1')
    ...
    , jnaPlatform("net.java.dev.jna:jna-platform:5.17.0")
...
//    , jline2('jline:jline:2.12')
    ...
    , regexp1('dk.brics:automaton:1.12-4'  )
...
//    guavaMavenId('com.google.guava:guava:21.0')
    ...
    , xtextEclipseLangServerProtoclIntegration1('org.eclipse.xtext:org.eclipse.xtext.xbase.lib:2.40.0') // may be integration, not sure
    ...
    , servletApi2("javax.servlet:javax.servlet-api:4.0.1")
    ...
    , sqlLiteJdbc( 'org.xerial:sqlite-jdbc:3.49.1.0')
    /**
...
//    , jasypt('org.jasypt:jasypt:1.9.2')
    ...
    , minaCore('org.apache.mina:mina-core:2.2.7')
    ...
    dockerJibCore('com.google.cloud.tools:jib-core:0.27.3'),
    ...
    charEncodingDetector('com.github.albfernandez:juniversalchardet:2.5.0'),
    ...
    // qrcode generator
    zxingCore('com.google.zxing:core:3.5.3'),
//    binaryCompatibilityValidator( 'org.jetbrains.kotlinx.binary-compatibility-validator:org.jetbrains.kotlinx.binary-compatibility-validator.gradle.plugin:0.13.2'),
    ...
    browserTester('org.htmlunit:htmlunit:4.21.0'),
    ...
    javacNetbeans('com.dukescript.nbjavac:nb-javac:jdk-27+26')
