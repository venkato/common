...
//    eclipseJavaCompiler('org.eclipse.jdt.core.compiler:ecj:4.6.1')
    ...
    , jnaPlatform("net.java.dev.jna:jna-platform:5.14.0")
    ,
    @Deprecated
    osInfo(  'com.github.oshi:oshi-core:6.6.1')
...
//    , jline2('jline:jline:2.12')
    ...
    , windowsAuth( 'com.github.waffle:waffle-jna:3.4.0')
...
//    guavaMavenId('com.google.guava:guava:21.0')
    ...
    , jcraftHostFix('com.github.mwiede:jsch:0.2.18')
    ...
    ,hutoolAllRandomUtils('cn.hutool:hutool-all:5.8.30')
    ,oshiCoreNativeUtils('com.github.oshi:oshi-core:6.6.2')
