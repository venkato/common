...
//    eclipseJavaCompiler('org.eclipse.jdt.core.compiler:ecj:4.6.1')
    ...
    , jodaTime('joda-time:joda-time:2.12.5')
    ...
    , jnaPlatform("net.java.dev.jna:jna-platform:5.13.0")
    ,
    @Deprecated
    osInfo(  'com.github.oshi:oshi-core:6.4.6')
...
//    , jline2('jline:jline:2.12')
    ...
    , packageurl("com.github.package-url:packageurl-java:1.4.1")
...
//    guavaMavenId('com.google.guava:guava:21.0')
    ...
    , commnonsLang3('org.apache.commons:commons-lang3:3.13.0')
    , commnonsText('org.apache.commons:commons-text:1.10.0')
    ...
    , sshjHierynomus('com.hierynomus:sshj:0.38.0')
    ...
    , jcraftHostFix('com.github.mwiede:jsch:0.2.11')
    ...
    , commonsCompress('org.apache.commons:commons-compress:1.22')
    ...
    ,hutoolAllRandomUtils('cn.hutool:hutool-all:5.8.22')
    ,oshiCoreNativeUtils('com.github.oshi:oshi-core:6.4.6')
...
//    , jasypt('org.jasypt:jasypt:1.9.2')
    ...
    dockerJibCore('com.google.cloud.tools:jib-core:0.25.0'),
...
//    binaryCompatibilityValidator( 'org.jetbrains.kotlinx.binary-compatibility-validator:org.jetbrains.kotlinx.binary-compatibility-validator.gradle.plugin:0.13.2'),
    ...
    videoPlayerForSwing(  'uk.co.caprica:vlcj:4.8.2'),
...
//            'com.google.oauth-client:google-oauth-client:1.21.0'),
    ...
    static List<? extends MavenIdContains> specific = [GitMavenIds.jgit, junit, CustObjMavenIds.slf4jApi, jnrJffi, portForward, jna, jnaPlatform, gnuGetOpt, jodaTime, rstaui,//
                                                       ...
                                                       commnonsLang3, commnonsText, commonsCodec, groovySshShell, javaCompiler1, javaCompiler1SymbolResolver,icePdfCore, icePdfViewer, j2sshMaverick, commonsNet, commonsCollection4,//
                                                        jsoup, jcraftHostFix, httpClient, httpCore,httpCoreNio, jideOss, jmdns, jcifs, mx4j, trileadSsh, cssParser, commonsHttpOld, cssParser3, CustObjMavenIds.compressAbstraction,//
