...
public enum CustObjMavenIds implements MavenIdContains, ToFileRef2 {
    ...
    , junrar1('com.github.junrar:junrar:7.4.1')
    , slf4jApi('org.slf4j:slf4j-api:1.7.35')
    , slf4jJdkLogger('org.slf4j:slf4j-jdk14:1.7.35')
    ...
    , svnKit('org.tmatesoft.svnkit:svnkit:1.10.4')
    ;
