...
enum NexusSearchMavenIds implements MavenIdContains, ToFileRef2 {
    ...
    indexer('org.sonatype.nexus.plugins:nexus-indexer-lucene-model:2.14.21-02'),
    restletBridge('org.sonatype.nexus.plugins:nexus-restlet-bridge:2.14.21-02'),
    restlet1x('org.sonatype.nexus.plugins:nexus-restlet1x-model:2.14.21-02'),
    rest('org.sonatype.nexus:nexus-rest:3.37.3-02'),
