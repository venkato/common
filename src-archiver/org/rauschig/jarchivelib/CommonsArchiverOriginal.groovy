...
public class CommonsArchiverOriginal extends CommonsArchiver{
    ...
    @Override
    ArchiveInputStream createArchiveInputStream(File archive) throws IOException {
        return super.createArchiveInputStream(archive)
    }

    @Override
    ArchiveInputStream createArchiveInputStream(InputStream archive) throws IOException {
        return super.createArchiveInputStream(archive)
    }

    @Override
    ArchiveOutputStream createArchiveOutputStream(File archiveFile) throws IOException {
        return super.createArchiveOutputStream(archiveFile)
    }

    @Override
    void assertExtractSource(File archive) throws FileNotFoundException, IllegalArgumentException {
        super.assertExtractSource(archive)
    }

    @Override
    void writeToArchive(File[] sources, ArchiveOutputStream archive) throws IOException {
