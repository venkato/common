...
@CompileStatic
class JavaClassPathHook  {
    private static final Logger log = JrrClassUtils.getJdkLogForCurrentClass();


    public static InitInfo initInfo = new InitInfo(JrrClassUtils.getCurrentClass())
...
/*
    ...
    Object getImpl(Object key) {
        ...
        boolean booleanIs8 = JavaVersionDetector.javaVersionDetector.detectIs8WithCache(list[0])
        if(!booleanIs8) {
            IdeaJavaRunner2Settings.jvmJava11Options.reverse(false).each {
