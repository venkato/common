...
class JavaClassPathHookV2 extends InjectedCode {
    //private static final Logger log = LogManager.getLogger(JrrClassUtils.getCurrentClass());
    ...
    private ArrayList<TargetValue<String>> findCmdLine1(TargetedCommandLineBuilder builder) {
        if (ideaCmdLineField == null) {
            try {
                ideaCmdLineField = JrrClassUtils.findField(TargetedCommandLineBuilder, 'myParameters')
