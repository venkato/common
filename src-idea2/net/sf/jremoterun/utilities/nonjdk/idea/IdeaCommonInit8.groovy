...
import net.sf.jremoterun.utilities.nonjdk.javalangutils.shutdowner.LogExitTimeHook
...
class IdeaCommonInit8 implements Runnable {
    ...
    static void init1Impl() {
        ...
        net.sf.jremoterun.utilities.nonjdk.idea.IdeaAsnyLoggerDisable.checkLogSync()
