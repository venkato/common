...
class IdeaClasspathImportFailed implements NewValueListener<Throwable> {
    ...
    void newValue(Throwable throwable) {
        try {
            net.sf.jremoterun.utilities.JrrUtilitiesShowE.showException('Classpath imported failed', throwable)
            ...
            net.sf.jremoterun.utilities.JrrUtilitiesShowE.showException('failed play audio', e)
        }
    }
