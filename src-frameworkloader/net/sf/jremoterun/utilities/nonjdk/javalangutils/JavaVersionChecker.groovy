...
class JavaVersionChecker {
    ...
    public static String javaVersionPropName = "java.specification.version"
    ...
    static boolean isJavaVersionImpl18() {
        String java_version = System.getProperty(javaVersionPropName)
        return java_version == goodJavaVersion
    }
