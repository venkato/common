...
@Deprecated
@CompileStatic
public class JrrStaticCompilationVisitorDel extends StaticCompilationVisitor {
    public JrrStaticCompilationVisitorDel(SourceUnit unit, ClassNode node) {
        super(unit, node);
    }


    private static final Logger log = Logger.getLogger(JrrStaticCompilationVisitorDel.class.getName());
