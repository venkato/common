...
public class JrrStaticCompileTransformationDel extends StaticCompileTransformation {

    private static final Logger log = Logger.getLogger(JrrStaticCompileTransformationDel.name);

    public
    static JrrGroovyStaticCompilationVisitorFactoryDel compilationVisitorFactory = new JrrGroovyStaticCompilationVisitorFactoryDel();
