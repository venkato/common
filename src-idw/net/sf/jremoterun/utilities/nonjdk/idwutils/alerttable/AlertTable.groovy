...
class AlertTable implements ShowAlertJmx, DefaultObjectName {
    ...
    @Deprecated
    public static AlertTable defaultAlertTable// = net.sf.jremoterun.utilities.nonjdk.idwutils.alerttable.AlertTableCreator.alertTableCreator.getInstanceOrCreate()
    ...
    static void addAlertS(String msg, Throwable e) {
        AlertTable defaultAlertTable1 = AlertTableCreator.alertTableCreator.getInstanceOrCreate()
