    ...
    AlertTable() {
        ...
        tableSummary.addMouseListener(new MouseAdapter() {
            ...
            void mouseClicked(MouseEvent e) {
                try {
                    ...
                    net.sf.jremoterun.utilities.JrrUtilitiesShowE.showException("failed show selected msg", e2)
                }
            }
        });
        showExceptionButton.addActionListener {
            try {
                ...
                net.sf.jremoterun.utilities.JrrUtilitiesShowE.showException("failed show exception", e2)
            }
        }
